...
async function images() {
    imagecomp(
        'app/images/src/**/*',
        'app/images/dest/', { compress_force: false, statistic: true, autoupdate: true }, false, // Настраиваем основные параметры
...
//можно создать для предварительной очистки целевой папки
function cleandist() {
